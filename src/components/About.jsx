    ...
    <>
      ...
      <div className="about">
        <div className="container">
          ...
          <h2>The Project</h2>
          <p>
            This project was created to explore how a real-world online store
            can be designed and developed using modern frontend technologies.
            The goal was to create a clean, responsive, and intuitive shopping
            experience where users can easily browse products, explore
            categories, and view detailed product information.
          </p>
          ...
          <p>
            ...
            <strong>DummyJSON API</strong>, allowing the application to work
            with realistic product information without requiring a custom
            backend.
          </p>
          ...
          <p>
            ...
            structure, user experience, responsive design, and handling data
          ...
          <p>
            ...
            build something that feels like an actual e-commerce application
            while strengthening my understanding of React and frontend
            development.
          </p>

          <p>
            Every part of the project, from fetching products to displaying
            individual product details, is built around turning external data
            into a usable and engaging interface.
          </p>

          <h2>What's Next?</h2>
          <p>
            This project is still evolving. There are many features that could
            be added in the future, including:
          </p>
          ...
          <p>
            The project represents my ongoing journey in frontend development
            and my goal of building practical applications rather than only
